export const constants = {
  name: 'Shubham Hagawane',
  avatar: 'https://avatars.githubusercontent.com/u/35477201?v=4',
  profilesUrls: {
    linkedin: 'https://www.linkedin.com/in/shubham-hagawane-181380229/',
    github: 'https://github.com/ShubhamKH08/',
    email: 'hagawaneshubham908@gmail.com',
    cv: '/04/03/2022.pdf',
    twitter: 'https://x.com/ShubhamKH07',
    number: '+91 ',
    whatsapp: 'https://wa.me/',
    instagram: 'https://medium.com/@ShubhamKH08',
    facebook: 'https://github.com/ShubhamKH08/',
  },
  icons: {
